...
<img src="https://i.imgur.com/LzIW6iS.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>   
</p>
<p>
...
<p>
<img src="https://i.imgur.com/AUXoP1E.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>
<img src="https://i.imgur.com/nSM9dA2.png" height="80%" width="80%" alt="Disk Sanitization Steps"/>  
</p>
<p>
After the ticket is assigned to the appropriate worker then the worker might reach back out to the client to get a better undrestanding of the issue and may even consult among coworkers to figure out and solve the clients issue. Throughout the process the worker would be sending updates to the client to let them know the progress of their ticket. Once solved the worker would then reach back out to the client letting them know that the iissue has been solved and confirm that everything is running smooth with the client. Once client confirms issue is solved on their end then the worker would put final notes on the ticket and proceed to close the ticket out.
</p>
<br />
